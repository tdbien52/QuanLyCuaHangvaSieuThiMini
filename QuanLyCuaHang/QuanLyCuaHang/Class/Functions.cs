...
namespace QuanLyCuaHang.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            con.ConnectionString = ("Data Source =TRANDINHBIEN; Initial Catalog=QL_Shopsale;Integrated Security =True");
            //con.ConnectionString = ("Data Source= DESKTOP-S7J7NDH\\SQLEXPRESS;Initial Catalog = QL_Shop; Integrated Security=True");
